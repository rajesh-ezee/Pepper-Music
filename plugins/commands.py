...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/HeartBeat_Muzic'),
            InlineKeyboardButton('🧩 Source', url='https://t.me/HeartBeat_Muzic')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://t.me/HeartBeat_Muzic'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/HeartBeat_Muzic'),     
        ],
        [
